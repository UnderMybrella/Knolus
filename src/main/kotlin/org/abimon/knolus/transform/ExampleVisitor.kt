...
class ExampleVisitor(val restrictions: KnolusTransVisitorRestrictions<*>, val parser: ExampleParser, val delegate: TransKnolusParserVisitor): ExampleParserBaseVisitor<KorneaResult<KnolusUnion>>() {
    ...
    override fun visitDeclareVariable(ctx: ExampleParser.DeclareVariableContext): KorneaResult<KnolusUnion.DeclareVariableAction> = delegate.visitDeclareVariable(TransDeclareVariableBlueprint(ctx))
    override fun visitSetVariableValue(ctx: ExampleParser.SetVariableValueContext): KorneaResult<KnolusUnion.AssignVariableAction> = delegate.visitSetVariableValue(TransAssignVariableBlueprint(ctx))
    ...
    override fun visitDeclareFunctionBody(ctx: ExampleParser.DeclareFunctionBodyContext): KorneaResult<KnolusUnion.ScopeType> = delegate.visitDeclareFunctionBody(TransDeclareFunctionBodyBlueprint(ctx))
    override fun visitFunctionCall(ctx: ExampleParser.FunctionCallContext): KorneaResult<KnolusUnion.VariableValue<KnolusLazyFunctionCall>> = delegate.visitFunctionCall(TransFunctionCallBlueprint(ctx))
    override fun visitFunctionCallParameter(ctx: ExampleParser.FunctionCallParameterContext): KorneaResult<KnolusUnion.FunctionParameterType> = delegate.visitFunctionCallParameter(TransFunctionCallParameterBlueprint(ctx))
    override fun visitMemberFunctionCall(ctx: ExampleParser.MemberFunctionCallContext): KorneaResult<KnolusUnion.VariableValue<KnolusLazyMemberFunctionCall>> = delegate.visitMemberFunctionCall(TransMemberFunctionCallBlueprint(ctx))
    override fun visitVariableReference(ctx: ExampleParser.VariableReferenceContext): KorneaResult<KnolusUnion.VariableValue<KnolusVariableReference>> = delegate.visitVariableReference(TransVariableReferenceBlueprint(ctx))
    override fun visitMemberVariableReference(ctx: ExampleParser.MemberVariableReferenceContext): KorneaResult<KnolusUnion.VariableValue<KnolusPropertyReference>> = delegate.visitMemberVariableReference(TransMemberVariableReferenceBlueprint(ctx))
    override fun visitVariableValue(ctx: ExampleParser.VariableValueContext): KorneaResult<KnolusUnion.VariableValue<KnolusTypedValue>> = delegate.visitVariableValue(TransVariableValueBlueprint(ctx))
